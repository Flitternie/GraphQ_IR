...
from bart2ir.train import cal_performance
...
def inference(args):
    ...
    outputs, targets = predict(args, model, val_loader, device, tokenizer)
...
def prepare(dataset, args):
    ...
    outputs, _ = predict(args, model, val_loader, device, tokenizer)
